        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-3xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800">
            ...
            <form onSubmit={handleCreateJob} className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
              ...
              {/* Fuel Kilometer Allowance (Manual input + Presets) */}
              <div className="rounded-xl border border-violet-100 dark:border-violet-950/30 bg-violet-50/20 dark:bg-violet-950/10 p-4 space-y-3">
                <div className="flex items-center justify-between">
                  <label className="block text-[10px] font-bold text-violet-500 uppercase tracking-widest">
                    Fuel Allowance (Kilometers)
                  </label>
                  {calculatingDistance && (
                    <span className="text-[8px] text-slate-400 animate-pulse">Calculating automatically...</span>
                  )}
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <div className="relative flex-1">
                    <input
                      ...
                      className="w-full text-xs font-bold rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-3 pr-10 outline-none focus:border-secondary text-slate-800 dark:text-white"
                    />
                ...
                <div className="flex flex-wrap gap-1.5">
                  ...
                  <button
                    ...
                    className="text-[9px] font-bold px-2.5 py-1.5 rounded-lg border bg-slate-100 dark:bg-slate-800 border-transparent text-slate-500 hover:bg-slate-200 hover:text-slate-700 dark:hover:bg-slate-700 cursor-pointer"
                  >
                    Clear
                  </button>
                </div>
                ...
                {calculationReason && (
                  <p className="text-[9px] text-slate-450 leading-relaxed italic text-left">
                    💡 {calculationReason}
                  </p>
                )}
              </div>
